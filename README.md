   ...
   BigBlueButton is an open-source video conferencing tool built **"by teachers, for teachers"**. BBB has all the core features you would expect in a web conferencing system.

   Unlike generic web conferencing systems, BBB is designed for online learning; it extends these core features to enable a teacher to engage students in virtual office hours, group collaboration, and fully online classes.
