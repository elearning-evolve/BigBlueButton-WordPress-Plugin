<div class="notice notice-info">
	...
	<?php if ( isset( $bbb_admin_review_message ) ) { ?>
		...
		<a target="_blank" rel="noopener" href="https://wordpress.org/support/plugin/video-conferencing-with-bbb/reviews/#new-post">
			<button class="button button-sm-primary bbb-warning-notice" data-notice="<?php esc_html_e( $bbb_warning_type ); ?>" data-nonce="<?php esc_html_e( $bbb_admin_notice_nonce ); ?>">Update Author</button>
		</a>
